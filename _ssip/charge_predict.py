...
def load_aimnet2(device: str = "cpu"):
    ...
    # Route 1: aimnet2calc (auto-selects device internally)
    try:
        import aimnet2calc
        model = aimnet2calc.AIMNet2Calculator("aimnet2_wb97m")
        return model, "aimnet2calc"
    except Exception as e:
        print(f"[DEBUG] aimnet2calc Route 1 failed: {e}", flush=True)
